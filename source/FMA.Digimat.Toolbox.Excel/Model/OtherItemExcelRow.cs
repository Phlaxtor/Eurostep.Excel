...
{
    public class OtherItemExcelRow : CommonExcelRow
    {
        public override string SheetName => ExcelSheetName.Other;
        ...
        public override Dictionary<string, string> HeadingsWithColumnNames => new() {
            ...
            { ColumnHeading.USOrigin                   , "AD" },
            { ColumnHeading.RadioactiveMaterial        , "AE" },
        };
    }
}
